...
-- 	ON (`parent_comments`.`story_id` = `comments`.`story_id`)
-- 	WHERE `read_ribbons`.`is_following` = 1
-- 	AND `parent_comments`.`id` = `comments`.`parent_comment_id`
